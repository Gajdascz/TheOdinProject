...
/**
 * Selects the first message from the messages table.
 *
 * @returns SELECT * FROM messages LIMIT 1
 */
const SELECT_ALL = (limit = 1) => format("SELECT * FROM messages LIMIT %L", limit);

export { INSERT_MESSAGE, SELECT_BY_USERNAME, SELECT_ALL_MESSAGES, SELECT_BY_ID, SELECT_ALL };
